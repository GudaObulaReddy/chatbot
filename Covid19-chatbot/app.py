...
def processRequest(req):
    ...
    if intent == 'covid_searchcountry':
        ...
        val = log.getcasesForEmail("country", "fulfillmentText", db)
        print("===>",val)
...
def configureDataBase():
    client = MongoClient("mongodb+srv://Obul7032813598:Obul7032813598@cluster0.bvh60.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
